 ...
 * Use the [SummaryT4Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SummaryT4Fragment : Fragment() {
    ...
    val view = inflater.inflate(R.layout.fragment_summary_t4, container, false)
    val btnt4back = view.findViewById<ImageButton>(R.id.btnt4back)

    val dbHelper = ExpenseDatabaseHelper(requireContext())
    val expenses = dbHelper.getExpensesByCategory("Others")
    ...
    val recyclerView: RecyclerView = view.findViewById(R.id.rvt4)
    val adapter = ExpenseAdapter(requireContext(), expenses)
    recyclerView.adapter = adapter
    recyclerView.layoutManager = LinearLayoutManager(requireContext())


    btnt4back.setOnClickListener{
