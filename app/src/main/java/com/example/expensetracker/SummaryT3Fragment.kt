 ...
 * Use the [SummaryT3Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SummaryT3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_summary_t3, container, false)
        val btnt3back = view.findViewById<ImageButton>(R.id.btnt3back)

        val dbHelper = ExpenseDatabaseHelper(requireContext())
        val expenses = dbHelper.getExpensesByCategory("Study")
        ...
        val recyclerView: RecyclerView = view.findViewById(R.id.rvt3)
        val adapter = ExpenseAdapter(requireContext(), expenses)
        recyclerView.adapter = adapter
        recyclerView.layoutManager = LinearLayoutManager(requireContext())


        btnt3back.setOnClickListener{
